...
return [
    ...
    'attributes'           => [
		...
		'bearsBiometryData.age' => __('Visual age estimate'),
		'bearsBiometryData.baculum_length' => __('Length of os penis (penis bone - baculum)'),
		'bearsBiometryData.nipple_length' => __('Teats length'),
		'bearsBiometryData.testicals_left_length' => __('Left testicle length'),
		'bearsBiometryData.testicals_left_width' => __('Left testicle width'),
		'bearsBiometryData.testicals_right_length' => __('Right testicle length'),
		'bearsBiometryData.testicals_right_width' => __('Right testicle width'),
		'bearsBiometryData.hair_tuft_length' => __('Length of hair tuft (for lynx only) (0-15 cm)'),
		'bearsBiometryData.masa_bruto' => __('Gross'),
		'bearsBiometryData.masa_neto' => __('Net'),
		'bearsBiometryData.body_length' => __('Body length'),
		'bearsBiometryData.tail_length' => __('Tail length without hair'),
		'bearsBiometryData.shoulder_height' => __('Shoulder height'),
		'bearsBiometryData.head_circumference' => __('Head circumference'),
		'bearsBiometryData.neck_circumference' => __('Neck circumference'),
		'bearsBiometryData.thorax_circumference' => __('Thorax circumference'),
		'bearsBiometryData.abdomen_circumference' => __('Abdomen circumference'),
		'bearsBiometryData.upper_left_canines_length' => __('Length of left canines') . ': ' . __('Upper'),
		'bearsBiometryData.lower_left_canines_length' => __('Length of left canines') . ': ' . __('Lower'),
		'bearsBiometryData.upper_right_canines_length' => __('Length of right canines') . ': ' . __('Upper'),
		'bearsBiometryData.lower_right_canines_length' => __('Length of right canines') . ': ' . __('Lower'),
		'bearsBiometryData.distance_between_upper_canines' => __('Distance between canines') . ': ' . __('Upper'),
		'bearsBiometryData.distance_between_lower_canines' => __('Distance between canines') . ': ' . __('Lower'),
		'bearsBiometryData.number_of_premolars_in_the_upper_jaw' => __('Number of premolars') . ': ' . __('Upper jaw (left + right)'),
		'bearsBiometryData.number_of_premolars_in_the_lower_jaw' => __('Number of premolars') . ': ' . __('Lower jaw (left + right)'),
		'bearsBiometryData.front_left_paw_length' => __('Front left paw') . ': ' . __('Length'),
		'bearsBiometryData.front_left_paw_width' => __('Front left paw') . ': ' . __('Width'),
		'bearsBiometryData.front_right_paw_length' => __('Front right paw') . ': ' . __('Length'),
		'bearsBiometryData.front_right_paw_width' => __('Front right paw') . ': ' . __('Width'),
		'bearsBiometryData.hind_left_paw_length' => __('Hind left paw') . ': ' . __('Length'),
		'bearsBiometryData.hind_left_paw_width' => __('Hind left paw') . ': ' . __('Width'),
		'bearsBiometryData.hind_right_paw_length' => __('Hind right paw') . ': ' . __('Length'),
		'bearsBiometryData.hind_right_paw_width' => __('Hind right paw') . ': ' . __('Width'),
		'bearsBiometryData.ear_length_without_hair' => __('Ear length without hair')
    ],
];
