...
class Controller extends BaseController
{
	...
	public function exportAnimalHandlings()
	{
		...
		$csv->insertOne([
			'animal_id', 'species_list', 'sex_list', 'status', 'name', 'description', '',

			'animal_handling_id', 'way_of_withdrawal_list',
			'animal_conflictedness', 'animal_conflictedness_details', 'number_of_removal_in_the_hunting_administrative_area',
			'conflict_animal_removal_list', 'licence_list', 'licence_number', 'project_name', 'receiving_country', 'telemetry_uid', 'biometry_loss_reason_list', 'biometry_loss_reason_description', 'animal_handling_date', 'place_of_removal', 'place_type_list', 'place_type_list_details', 'lat', 'lng', 'hunting_management_area', 'hunter_finder_name_and_surname', 'hunter_finder_country', 'witness_accompanying_person_name_and_surname',  'tooth_type_list', 'taxidermist_name_and_surname', 'hunting_ground', 'spatial_unit_gid', 'number_of_removal_in_the_hunting_administration_area', 'animal_status_on_handling', ' ',

			'biometry_data_id', 'age', 'masa_bruto', 'masa_neto', 'body_length', 'shoulder_height', 'head_circumference', 'neck_circumference', 'thorax_circumference', 'abdomen_circumference', 'baculum_length', 'nipple_length', 'teats_wear_list', 'tail_length', 'ear_length_without_hair', 'hair_tuft_length', 'hind_left_paw_length', 'hind_right_paw_length', 'front_right_paw_length', 'front_left_paw_length', 'hind_left_paw_width', 'hind_right_paw_width', 'front_left_paw_width', 'front_right_paw_width',
