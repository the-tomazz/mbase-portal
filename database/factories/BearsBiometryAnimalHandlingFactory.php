...
class BearsBiometryAnimalHandlingFactory extends Factory
{
	...
	public function definition()
	{
		return [
			...
			'date_and_time_of_biometry_measurements' => now(),
			...
			'sample_taken' => mt_rand(0, 1),
			'hair_sample_taken' => mt_rand(0, 1),
			'hair_sample_taken_details' => Str::random(10),
			'dna_sample_taken' => mt_rand(0, 1),
			'dna_sample_taken_details' => Str::random(10),
